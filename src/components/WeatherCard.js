...
const WeatherCard = ({ weatherData, error }) => {
  if (error) {
    return (
      <div className="bg-red-600 dark:bg-gray-800 p-6 rounded-xl shadow-lg text-center text-white">
  ...
  return (
    <div className="bg-gradient-to-r  from-blue-500 to-purple-600 dark:from-gray-800 dark:to-gray-800 p-3 rounded-xl shadow-lg text-center text-white">
      ...
      <p className="text-3xl sm:text-5xl font-bold mb-4">{weatherData.main.temp}°C</p>
